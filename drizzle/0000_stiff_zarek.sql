...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "gohumanfund_learning_resource" (
	"id" serial PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "gohumanfund_success_story" (
	"id" serial PRIMARY KEY NOT NULL,
	"title" varchar(255) NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "gohumanfund_workshop" (
	"id" serial PRIMARY KEY NOT NULL,
	"title" varchar(255) NOT NULL,
	"description" text NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "subscriptions" ADD CONSTRAINT "subscriptions_user_id_gohumanfund_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."gohumanfund_user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
